...
using AutoMapper;
using AuraTicket.Services.ShoppingBasket.Models;
using AuraTicket.Services.ShoppingBasket.Repositories;
using AuraTicket.Services.ShoppingBasket.Services;
using Microsoft.AspNetCore.Mvc;

namespace AuraTicket.Services.ShoppingBasket.Controllers
{
